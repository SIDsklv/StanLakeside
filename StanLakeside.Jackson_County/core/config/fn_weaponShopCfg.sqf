				...
				default
				{
					["Bronie Dlugie Rebelii",
						[
							...
							["SMG_02_F",nil,80000],
							["RH_sbr9_wdl",nil,95000],
							["RH_sbr9_tg",nil,95000],
							["RH_sbr9_des",nil,95000],
							["RH_32Rnd_9mm_M822",nil,750],
							["AG_MP9_sand_peq",nil,67500],
							["AG_MP9_wcam_peq",nil,67500],
							["AG_MP9_digi_peq",nil,67500],
							["AG_MP9_wcam",nil,67500],
							["AG_MP9_digi",nil,67500],
							["AG_MP9_sand",nil,67500],
							["AG_MP9_folded_wcam",nil,58000],
							["AG_MP9_folded_digi",nil,58000],
							["AG_MP9_folded_sand",nil,58000],
							["30Rnd_45ACP_Mag_SMG_01",nil,750],
							["30Rnd_9x21_Mag",nil,750],
							["optic_Aco",nil,2500],
							["optic_ACO_grn_smg",nil,2500],
							["chakFNP90_50rnd_skin1",nil,115500],
